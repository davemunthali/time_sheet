 ...
 * @property \App\Model\Table\TimesheetsTable|\Cake\ORM\Association\BelongsTo $Timesheets
...
class ActivitiesTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['timesheet_id'], 'Timesheets'));
